  ...
  return (
    <Card className={cn(isLoading && 'animate-pulse')}>
      <CardHeader>
        ...
        <CardDescription>5 produk terlaris berdasarkan kuantitas</CardDescription>
      </CardHeader>
      <CardContent>
        {top5.length > 0 ? (
          ...
          <div className="py-6">
            <EmptyState
              title={isLoading ? 'Memuat data...' : 'Belum ada penjualan'}
              description={
                isLoading ? undefined : 'Belum ada transaksi completed hari ini'
              }
            />
          </div>
        )}
