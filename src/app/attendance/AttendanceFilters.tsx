...
import { AttendanceListParams, AttendanceStatus } from '../services/api';
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        {localFilters.store_id && (
          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
            Store: {stores.find(s => s.id === localFilters.store_id)?.name || 'Unknown'}
            <button
        ...
        {localFilters.shift_store_id && (
          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
            Shift: {shiftStores.find(s => s.id === localFilters.shift_store_id)?.name || 'Unknown'}
            <button
