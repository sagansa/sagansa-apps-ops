  ...
  return (
    <AdminLayout>
      ...
      <section className="mt-6 space-y-4">
        ...
        {activeTenantId ? (
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Example: Jakarta Outlet"
                  />
                </div>
                ...
                <div>
                  <p className="block text-sm font-medium text-gray-700">Stores</p>
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Stores</th>
                    <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Sync Source</th>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {loading && groups.length === 0 ? (
                    ...
                    <tr>
                      <td colSpan={4} className="px-6 py-8 text-center text-sm text-gray-500">No store groups yet.</td>
                    </tr>
                  ) : groups.map((group) => (
                    <tr key={group.id}>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-500">
                        {group.stores.length > 0
                          ...
                          : <span className="text-xs text-gray-400">No stores</span>}
                      </td>
                      <td className="px-6 py-4">
                        <select
          ...
          <div className="rounded-lg border border-dashed border-gray-300 bg-white p-10 text-center text-sm text-gray-500">
            {isSuperAdmin ? 'Select a tenant to manage store groups.' : 'Your tenant is not available.'}
          </div>
        )}
      </section>
      ...
      <ConfirmationDialog
        ...
        message={`Delete "${deleteTarget?.name}"? Stores will stay available but no longer belong to this group.`}
        confirmText="Delete"
        cancelText="Cancel"
        variant="danger"
        loading={loading}
